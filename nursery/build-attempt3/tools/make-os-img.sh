...
# copy sectors
$SFS wrsect -i $IMG -s $STAGE1_FIRST_SECTOR -c $STAGE1_SECTOR_COUNT -f ../build/kernel/stage1.bin
$SFS wrsect -i $IMG -s $STAGE2_FIRST_SECTOR -c $STAGE2_SECTOR_COUNT -f ../build/kernel/stage2.bin
$SFS wrsect -i $IMG -s $KERNEL_FIRST_SECTOR -c $KERNEL_SECTOR_COUNT -f ../build/kernel/kernel.bin
