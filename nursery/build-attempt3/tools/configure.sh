...
KERNEL_UTIL_PAGE_ADDRESS=0x90000  # we can use up to 0x9FBFF = 639k
KERNEL_UTIL_PAGE_SIZE_KB=4 # multiple of 4k
...
KERNEL_UTIL_PAGE_ADDRESS := $KERNEL_UTIL_PAGE_ADDRESS
KERNEL_UTIL_PAGE_SIZE_KB := $KERNEL_UTIL_PAGE_SIZE_KB
...
#define KERNEL_UTIL_PAGE_ADDRESS  $KERNEL_UTIL_PAGE_ADDRESS
#define KERNEL_UTIL_PAGE_SIZE_KB  $KERNEL_UTIL_PAGE_SIZE_KB
