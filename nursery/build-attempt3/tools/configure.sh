...
KERNEL_COPY_AREA_ADDRESS=0x90000  # we can use up to 0x9FBFF = 639k
KERNEL_COPY_AREA_SIZE_KB=8        # 2 pages, dest+source
...
KERNEL_COPY_AREA_ADDRESS := $KERNEL_COPY_AREA_ADDRESS
KERNEL_COPY_AREA_SIZE_KB := $KERNEL_COPY_AREA_SIZE_KB
...
#define KERNEL_COPY_AREA_ADDRESS  $KERNEL_COPY_AREA_ADDRESS
#define KERNEL_COPY_AREA_SIZE_KB  $KERNEL_COPY_AREA_SIZE_KB
