...
#endif
#ifndef KERNEL_FIRST_SECTOR
    #error KERNEL_FIRST_SECTOR not defined
#endif
...
int load_kernel() {
    ...
    uint32_t first_sector = KERNEL_FIRST_SECTOR;
    uint16_t remaining_sectors = KERNEL_SECTOR_COUNT;
