 ...
 * to a `long int` representation. It handles leading whitespace, an optional
 ...
 * @return The converted `long int` value. On overflow, `LONG_MAX` or `LONG_MIN`
 *         is returned and `errno` is set to `ERANGE`.
 *
 * @implNote
 * This is a complex string parsing function. It needs to:
...
long strtol(const char *str, char **endptr, int base) {
    // TODO: Implement strtol for your operating system.
    // This is a complex string parsing and integer conversion function.
