...
typedef struct pci_device_ops         pci_device_ops_t;
...
struct pci_device_ops {
    const char *(*class_name)(pci_device_t *dev);
    const char *(*subclass_name)(pci_device_t *dev);
    
    uint8_t (*read_config_byte)(pci_device_t *dev, uint8_t offset);
    uint16_t (*read_config_word)(pci_device_t *dev, uint8_t offset);
    uint32_t (*read_config_dword)(pci_device_t *dev, uint8_t offset);

    void (*write_config_byte)(pci_device_t *dev, uint8_t offset, uint8_t value);
    void (*write_config_word)(pci_device_t *dev, uint8_t offset, uint16_t value);
    void (*write_config_dword)(pci_device_t *dev, uint8_t offset, uint32_t value);
};
