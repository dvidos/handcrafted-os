...
struct filesys_driver {
    ...
    int (*supported)(struct partition_deprecated *partition);
    
    // used in (un)mount operations
    int (*open_superblock)(struct partition_deprecated *partition, struct superblock *superblock);
