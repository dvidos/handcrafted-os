...
isr0x80:
  ...
  ; let's try for a uniform trapframe, see struct trapframe_t in C
  ...
  ; call the C function, passing a pointer to the actual trapframe
  push esp
  call isr_syscall
  add esp, 4

  ; restore the original segment descriptors
  pop gs
  pop fs
  pop es
  pop ds
