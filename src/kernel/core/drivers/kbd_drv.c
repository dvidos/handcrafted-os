...
struct scancode_info scancode_map[] = {
    ...
    /*          Ascii  Shifted  Special       Ext-Ascii   Ext-Special  */
    /* 0x00 */ {0,     0,       0,                   0,   0},
    ...
    /* 0x17 */ {'i',   'I',     KEY_I,               0,   0},
    /* 0x18 */ {'o',   'O',     KEY_O,               0,   0},
    /* 0x19 */ {'p',   'P',     KEY_P,               0,   KEY_MEDIA_NEXT},
    /* 0x1a */ {'[',   '{',     KEY_LEFT_SQ_BRKT,    0,   0},
    /* 0x1b */ {']',   '}',     KEY_RIGHT_SQ_BRKT,   0,   0},
    /* 0x1c */ {13,    13,      KEY_ENTER,           13,  KEY_KP_ENTER}, // enter
    /* 0x1d */ {0,     0,       0,                   0,   0}, // left control
    /* 0x1e */ {'a',   'A',     KEY_A,               0,   0},
    /* 0x1f */ {'s',   'S',     KEY_S,               0,   0},
    /* 0x20 */ {'d',   'D',     KEY_D,               0,   KEY_MEDIA_MUTE},
    /* 0x21 */ {'f',   'F',     KEY_F,               0,   KEY_MEDIA_CALC},
    /* 0x22 */ {'g',   'G',     KEY_G,               0,   KEY_MEDIA_PLAY},
    /* 0x23 */ {'h',   'H',     KEY_H,               0,   0},
    /* 0x24 */ {'j',   'J',     KEY_J,               0,   KEY_MEDIA_STOP},
    /* 0x25 */ {'k',   'K',     KEY_K,               0,   0},
    /* 0x26 */ {'l',   'L',     KEY_L,               0,   0},
    /* 0x27 */ {';',   ':',     KEY_SEMICOLON,       0,   0},
    /* 0x28 */ {'\'',  '"',     KEY_QUOTE,           0,   0},
    /* 0x29 */ {'`',   '~',     KEY_BACKTICK,        0,   0},
    /* 0x2a */ {0,     0,       0,                   0,   0}, // left shift
    /* 0x2b */ {'\\',  '|',     KEY_BACKSLASH,       0,   0},
    /* 0x2c */ {'z',   'Z',     KEY_Z,               0,   0},
    /* 0x2d */ {'x',   'X',     KEY_X,               0,   0},
    /* 0x2e */ {'c',   'C',     KEY_C,               0,   KEY_MEDIA_VOL_DOWN},
    /* 0x2f */ {'v',   'V',     KEY_V,               0,   0},
    /* 0x30 */ {'b',   'B',     KEY_B,               0,   KEY_MEDIA_VOL_UP},
    /* 0x31 */ {'n',   'N',     KEY_N,               0,   0},
    /* 0x32 */ {'m',   'M',     KEY_M,               0,   KEY_MEDIA_WWW},
    /* 0x33 */ {',',   '<',     KEY_COMMA,           0,   0},
    /* 0x34 */ {'.',   '>',     KEY_PERIOD,          0,   0},
    /* 0x35 */ {'/',   '?',     KEY_SLASH,           '/', KEY_KP_SLASH},
...
void keyboard_handler(registers_t* regs) {
    ...
    if (printable != 0 || special_key != 0) {
        key_event_t event;
        event.ascii = printable;
        event.keycode = 
            special_key |
            ((left_shift || right_shift) ? MOD_SHIFT : 0) |
