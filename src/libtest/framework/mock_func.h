...
struct mock_func_ops {
    void (*append_mock_value)(mock_func_info_t *info, int value);
    void (*append_expected_arg)(mock_func_info_t *info, char *arg_name, int expected_value);
    int (*dequeue_mock_value)(mock_func_info_t *info, const char *file, int line);
    int (*dequeue_expected_arg)(mock_func_info_t *info, char *arg_name, const char *file, int line);
