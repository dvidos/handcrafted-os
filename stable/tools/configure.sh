...
KERNEL_CUTOFF_ADDRESS     := $KERNEL_CUTOFF_ADDRESS
KERNEL_PMM_BITMAP_ADDR    := $KERNEL_PMM_BITMAP_ADDR
KERNEL_PMM_BITMAP_SIZE_KB := $KERNEL_PMM_BITMAP_SIZE_KB
...
#define KERNEL_PMM_BITMAP_ADDR    $KERNEL_PMM_BITMAP_ADDR
#define KERNEL_PMM_BITMAP_SIZE_KB $KERNEL_PMM_BITMAP_SIZE_KB
#define KERNEL_CUTOFF_ADDRESS     $KERNEL_CUTOFF_ADDRESS
